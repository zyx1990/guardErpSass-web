    ...
    export default {
        ...
        methods: {
            getList () {
                var _vm = this;
                _vm.$http.get({
                    url: 'guard-webManager/complainCategory/list.jhtml',
            ...
            remove (data) {
                ...
                _vm.$Modal.confirm({
                    ...
                    onOk: () => {
                        _vm.$http.post({
                            url: 'guard-webManager/complainCategory/del.jhtml',
                            data: {id: data.id},
                            success: function(res){
                                if(res.status == 200 ){
                                    _vm.getList()
            ...
            ok () {
                ...
                _vm.$refs['formValidate'].validate((valid) => {
                    if (valid) {
                        ...
                        var data = {};
                        if(_vm.seen) {
                            url = 'guard-webManager/complainCategory/edit.jhtml'
                            data = _vm.formValidate
                        } else {
                            url = 'guard-webManager/complainCategory/add.jhtml'
                            data = {
