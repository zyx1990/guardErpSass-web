                    ...
                    success: function(res){
                        if(res.status == 200 ){
                            if(res.data.code == 0) {
                                console.log(res)
                                _vm.getType()
                                _vm.formValidate.categoryId = res.data.content.Callback.categoryid
                                _vm.formValidate.taskTime = res.data.content.Callback.tasktime.split(' ')[0]
                                _vm.timeDay = res.data.content.Callback.tasktime.split(' ')[0]
                                _vm.formValidate.name = res.data.content.Callback.name
                                _vm.userName = res.data.content.Callback.userName
                                _vm.formValidate.userId = res.data.content.Callback.userid
                            } else {
                                _vm.powerLoad = 0
