        ...
        <div v-if='powerLoad > 0'>
            ...
            <div class="container-body">
                <Form ref="formValidate" :model="formValidate" :rules="ruleForm" :label-width="100" label-position="right">
                    ...
                    <Form-item label="扣减积分" prop="amount" required style="width:300px;">
                        <Input v-model="formValidate.amount" placeholder="请输入扣减积分"></Input>
                    </Form-item>
    ...
    export default {
        ...
        methods: {
            ...
            getId (id) {
                var _vm = this;
                _vm.$http.get({
                    url: 'guard-webManager/customerRecord/pointRebate.jhtml',
                    data: {customerId: id},
            ...
            save () {
                ...
                _vm.$refs['formValidate'].validate((valid) => {
                    if(valid) { 
                        _vm.$http.post({
                            url: 'guard-webManager/customerRecord/rebatePoint.jhtml',
