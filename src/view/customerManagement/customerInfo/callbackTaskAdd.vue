    ...
    <div class="container-box userPower">
        ...
        <div class="container-body">
            <Form ref="formValidate" :model="formValidate" :label-width="100" label-position="right">
                ...
                <Form-item label="提醒内容" prop="remark" required>
                    <Input v-model="formValidate.remark" type="textarea" :autosize="{minRows: 2,maxRows: 7}" placeholder="请输入提醒内容"></Input>
                </Form-item>
